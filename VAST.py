...
input_fileName = "VAST_input.xlsx"
...
PALLETS_AND_WRAPPING = pd.read_excel(input_fileName, sheet_name='Pallets&Wrapping 202402')
BOX = pd.read_excel(input_fileName, sheet_name='Box', header=5)
...
total = 0
for pline in plines:
  data = pd.read_excel(input_fileName, sheet_name=pline, header=1)
...
total_current = 0
total_new = 0
box = pd.read_excel(input_fileName, sheet_name='Box', header=4)
...
output.to_excel(output_fileName, sheet_name='Output', index=False)