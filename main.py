...
if check_password():
  ...
  with header_container:
    ...
    with col1:
      ...
      <div class="title-section">
        ...
        <h3 style="color: #6c757d; font-weight: 400; margin-top: -20px;">Instantly Analyze Business Cases</h3>
      </div>
      """, unsafe_allow_html=True)
  ...
  with col2:
    ...
    """, unsafe_allow_html=True)
    st.image("LMC_Logo.jpeg", width=130)
                  ...
                  response = AI_client.chat.completions.create(
                    ...
                    messages=[
                      ...
                      },
                      {
                        ...
                        {result_with_metrics.to_csv(index=False)}
